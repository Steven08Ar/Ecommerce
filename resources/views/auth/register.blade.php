    ...
    <style>
        ...
        * {
        ...
        .login-container {
            ...
            max-width: 90%;
            min-height: 580px;
            /* Un poco más alto para los campos extra */
    ...
    <div class="login-container">
        ...
        <div class="login-form-wrapper">
            ...
            <div class="form-header">
                ...
                <a href="{{ route('register') }}" class="active">Crear Cuenta</a>
            </div>

            <h2>Crea tu cuenta</h2>
            <p class="form-subtitle">Únete a nosotros para obtener las mejores ofertas.</p>
